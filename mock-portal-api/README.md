...
A lightweight mock server that implements the portal server API endpoints consumed by `platform-portal-backstage-plugin-backend`.
...
| GET | `/v1/api-products` | List API products — Solo Enterprise for kgateway / Gloo Gateway (GG) format |
